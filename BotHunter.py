...
def BotHunterTool(token, username=None, reponame=None):
    ...
    for key in prediction.keys():
        ...
        acc_prediction.extend([[key, prediction[key]]])
    
    return(acc_prediction)

parser = argparse.ArgumentParser()
parser.add_argument("--key", action='store', type=str, required= True, help="GitHub Token")
parser.add_argument('--csv', action='store', type=str, required=False, help="Location and file name to store the predictions in a csv file")
...
group.add_argument('--file-u',action='store', type=str, help="A text file with user names")
group.add_argument('--file-repo',action='store', type=str, help="A text file with repo names")
args = parser.parse_args()

accounts = []
repos = []
if args.u:
    accounts.extend([args.u])
elif args.repo:
